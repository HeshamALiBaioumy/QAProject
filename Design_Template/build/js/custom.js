...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [
            ...
            , e = [], f = 0; f < 30; f++) d.push([new Date(Date.today().add(f).days()).getTime(), randNum() + f + f + 10]);
        var g = {
            series: {
                lines: {
                    show: !1,
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function () {
            ...
            $("#form0 .btn").on("click", function () {
                $("#form0").parsley().validate(), a()
            });
        var a = function () {
            //!0 === $("#form0").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#pieChart").length) {
            var f = document.getElementById("pieChart"),
                i = {
                    datasets: [{
                        data: [V_MMC_Pending, V_MMC_Closed, V_MMC_Fixed],
                        backgroundColor: ["#455C73", "#BDC3C7", "#26B99A"],
                        label: "My dataset"
                    }],
                    labels: [V_MMC_Types_Pending, V_MMC_Types_Closed, V_MMC_Types_Fixed]
                };
            new Chart(f, {
                data: i,
                type: "pie",
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        element: "graph_donut",
        data: [{
            label: V_RCV_Types_Match,
            value: V_RCV_Match
        }, {
            label: V_RCV_Types_missMatch,
            value: V_RCV_missMatch
        }, {
            label: V_RCV_Types_Pending,
            value: V_RCV_Pending
        ...
        if ($("#echart_line").length) {
            ...
            f.setOption({
                ...
                xAxis: [{
                    type: "category",
                    boundaryGap: !1,
                    data: V_overAll_Denominator
                }],
                yAxis: [{
                    type: "value"
                }],
                series: [{
                    name: V_Overall_Types_CR,
                    type: "line",
                    smooth: !0,
                    itemStyle: {
                        normal: {
        ...
        if ($("#echart_pie2").length) {
            ...
            h.setOption({
                ...
                series: [{
                    ...
                    data: [
                        {
                            value: V_CL_Maker_Done,
                            name: V_CL_Types_Maker_Done
                        }, {
                            value: V_CL_Maker_Pending,
                            name: V_CL_Types_Maker_Pending
                        }, {
                            value: V_CL_Checker_Done,
                            name: V_CL_Types_Checker_Done
                        }, {
                            value: V_CL_Checker_Pending,
                            name: V_CL_Types_Checker_Pending
                        },
                        {
                            value: V_CL_Accepted,
                            name: V_CL_Types_Accepted
                        }, {
                            value: V_CL_Rejected,
                            name: V_CL_Types_Rejected
                        }, {
                            value: V_CL_Closed,
                            name: V_CL_Types_Closed
                        }
                    ]
                }]
            })
        ...
        if ($("#echart_donut").length) {
            ...
            i.setOption({
                ...
                series: [{
                    ...
                    data: [{
                        value: V_CR_Pending,
                        name: V_CR_Types_Pending
                    }, {
                        value: V_CR_Recieved,
                        name: V_CR_Types_RecievedPending
                    }, {
                        value: V_CR_Accepted,
                        name: V_CR_Types_Accepted
                    }, {
                        value: V_CR_Rejected,
                        name: V_CR_Types_Rejected
                    }]
                }]
            })
        }
